// Neopixel
#define PIN D3        // PIN where neopixel / WS2812 strip is attached
#define NUMLEDS 16    // Number of leds in the strip

const char HOSTNAME[] = "ESP8266_McLighting";   // Friendly hostname
const char AP_PASSWORD[] = "NeoPixel";

#define ENABLE_DISPLAY    // If defined, enable Arduino OTA code.
